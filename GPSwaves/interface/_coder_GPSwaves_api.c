 ...
 *
 * _coder_GPSwaves_api.c
 *
 * Code generation for function '_coder_GPSwaves_api'
 *
 */
...
void GPSwaves_api(const mxArray *prhs[4], const mxArray *plhs[9])
{
  emxArray_real_T *u;
  emxArray_real_T *v;
  emxArray_real_T *z;
  ...
  GPSwaves(u, v, z, fs, &Hs, &Tp, &Dp, E, f, a1, b1, a2, b2);
...
void GPSwaves_atexit(void)
{
  ...
  GPSwaves_xil_terminate();
}

void GPSwaves_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_GPSwaves_api.c) */
